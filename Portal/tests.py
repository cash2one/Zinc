...
class JiayuanHelperTestCase(TestCase):
    def setUp(self):
        self.jiayuan = JiayuanSearcher()
        self.helper = JiayuanHelper(self.jiayuan)
    ...
    def test_get_data_of_json(self):
        ...
        res = self.helper.get_data_of_json(json_string)
        self.assertEqual(len(res), 2)
        self.assertEqual(res[0]['uid'], 132917123)

    def test_process_single(self):
        list_data = [{"uid": 132917123, "realUid": 133917123, "nickname": "", "sex": "", "sexValue": "f",
                      "randAttr": "formal", "marriage": "", "height": "165", "education": "", "income": None,
                      "work_location": "", "work_sublocation": "", "age": 18, "image": "", "count": "30254",
                      "online": 0, "randTag": "", "randListTag": "", "userIcon": "", "helloUrl": "", "sendMsgUrl": "",
                      "shortnote": "", "matchCondition": ""},
                     {"uid": 132825533, "realUid": 133825533, "nickname": "", "sex": "", "sexValue": "f",
                      "randAttr": "formal", "marriage": "", "height": "160", "education": "", "income": None,
                      "work_location": "", "work_sublocation": "", "age": 18, "image": "", "count": "30254",
                      "online": 1, "randTag": "", "randListTag": "", "userIcon": "", "helloUrl": "", "sendMsgUrl": "",
                      "shortnote": "", "matchCondition": ""}]
